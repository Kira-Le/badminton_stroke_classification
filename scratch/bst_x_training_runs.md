...
All 64 recorded training runs of the BST-X (Architecture-1) model on ShuttleSet, built directly from the per-run `manifest.yaml` files under `src/bst_x/experiments/`. Generated 2026-06-02.
