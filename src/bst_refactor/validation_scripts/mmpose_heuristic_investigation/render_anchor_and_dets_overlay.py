...
Usage (per-class sampling):
    ...
    python src/bst_refactor/validation_scripts/mmpose_heuristic_investigation/render_anchor_and_dets_overlay.py \\
...
(``BST_MMPOSE_NPY_DIR`` points at the heuristic one). They live at
