...
expected per-clip files (specifically, that ``BST_MMPOSE_NPY_DIR`` contains
...
Run from the repo root::
    ...
    PYTHONPATH=src/bst_refactor:src/bst_refactor/stroke_classification \\
        python src/bst_refactor/validation_scripts/verify_env_paths.py
...
def main() -> int:
    ...
    if ok_mmpose:
        ...
        print(f'BST_MMPOSE_NPY_DIR clip-file counts:')
