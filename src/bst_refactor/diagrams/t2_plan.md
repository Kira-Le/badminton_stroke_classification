...
flowchart LR
  ...
  bst_refactor["bst&nbsp;repo&nbsp;tidy;&nbsp;bst->bst_x&nbsp;rename;<br>fork&nbsp;permission&nbsp;from&nbsp;C320&nbsp;group;<br>rebase&nbsp;for&nbsp;official&nbsp;BST&nbsp;fork<br>(promise&nbsp;to&nbsp;BST&nbsp;author)"]
  ...
  bst_refactor -. upstream .-> x3d_final
  bst_refactor -. upstream .-> finetune
